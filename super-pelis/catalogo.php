...
<body style="background: rgb(39, 37, 37)">
  ...
  <h2 class="text-center mt-5 mb-3 d-none d-md-block" style="color:white;">Catálogo <?php echo $total_articulos_db ?> Peliculas disponibles</h2>
  <h4 class="text-center mt-5 d-md-none" style="color:white;">Catálogo <?php echo $total_articulos_db ?> Peliculas disponibles</h4>
  <!--fin de conteo de peliculas -->
  ...
  <div class=" container " >
    <div class="row mt-3" >
      ...
      <div class="col-4 col-sm-3 col-md-2 p-0">
        <p class="idioma"><?php switch($dato['idioma']){case 'espaniol': echo "Español latino";break;case 'subespaniol': echo "Sub español";break;case 'espanioles': echo "Español";break;}?>
        </p>
